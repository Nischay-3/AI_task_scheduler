...
def generate_mock_suggestion(tasks):
    ...
    suggestion += "Tasks are ordered by nearest due date so urgent work appears first. "
    suggestion += "Use this schedule as a guide and adjust as needed for your priorities."
    return suggestion
